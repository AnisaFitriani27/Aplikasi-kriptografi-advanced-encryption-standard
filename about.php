...
?>
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      <header class="main-header hidden-print"><a class="logo" href="index.php" style="font-size:13pt">STIMIK ANTAR BANGSA</a>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <p>Di era ini teknologi semakin maju dan pesat, dimana kerahasiaan data salah satunya yang sangat penting bagi sebuah instansi<br>
