...
?>
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      <header class="main-header hidden-print"><a class="logo" href="index.php" style="font-size:13pt">STMIK ANTAR BANGSA</a>
  ...
  <div class="container-fluid">
    <p class="copyright">&copy; 2023. STMIK ANTAR BANGSA.</p>
  </div>
</footer>
      </div>
    </div>
